        ...
        with connection.cursor() as cursor:
            ...
            for pep_data in cursor.fetchall():
                ...
                if not pep.nacp_id:
                    ...
                    if not isinstance(declaration_data['user_declarant_id'], int):
                        print(declaration_data)
                ...
                # storing RelatedPerson (not PEP) nacp_id from PEP declaration
                    ...
                    for relative_data in detailed_declaration_data['step_2']['data']:
                        ...
                        for link in related_person_links:
                            ...
                            if is_same_full_name(
                                ...
                                related_person.nacp_id = relative_data.get('id')
                                if not isinstance(relative_data.get('id'), int):
                                    print(relative_data)
                                # if relative_data.get('id') in 1538488702458:
                                #     print(related_person, related_person.id, pep, pep.id)
                                related_person.save()
